...
export interface Annotation {
  ...
  /** Status: open = needs attention, claimed = bot accepted (in progress), done = bot completed (pending human review), resolved = human archived */
  status: "open" | "claimed" | "done" | "resolved";
  /** Who resolved it */
  resolvedBy?: string;
  resolvedAt?: string;
